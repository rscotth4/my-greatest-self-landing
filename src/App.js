...
export default function MyGreatestSelfLanding() {
  ...
  <div className="max-w-4xl mx-auto text-center">
    ...
    <p className="text-xl mb-12 text-slate-400 max-w-3xl mx-auto leading-relaxed">
      ...
      {/* Final CTA */}
      <section className="py-10 bg-gradient-to-br from-slate-900 via-sky-700 to-teal-500 text-white text-center">
      ...
      <footer className="bg-slate-900 text-slate-400 py-10">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mb-4">Master Your Mind. Transform Your Life.</p>
          <div className="space-x-6">
            <a href="/privacy" className="hover:text-white transition">Privacy Policy</a>
            <a href="/terms" className="hover:text-white transition">Terms of Service</a>
            <a href="/contact" className="hover:text-white transition">Contact</a>
          </div>
          <p className="mt-5 text-sm">© 2026 My Greatest Self. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
